...
Let's make our lives simple today by only looking at two species: filter the `penguins` dataset to only include Adelie and Chinstrap penguins. Use the functions that we learned in the first half of the quarter.
